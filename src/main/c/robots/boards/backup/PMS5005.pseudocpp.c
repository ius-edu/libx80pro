 ...
 * @see getSensorPot
 */
static const Buffer * setDCMotorPosition(Buffer *buf, unsigned char channel, short packetValue)
{
    assert (buf != NULL);
 ...
 */
static const Buffer * setDCMotorPulse(Buffer *buf, unsigned char channel, short packetValue)
{
    assert (buf != NULL);
