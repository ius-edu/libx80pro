...
public class PMS5005
{
	...
	public static short getSensorIrRange(short channel, int[] standardSensorAry, int[] customSensorAry)
	{
		...
		{
			result = (short) (((customSensorAry[2 * (channel - 1) + CUSTOM_IR_RANGE_OFFSET + 1] & 0xff) << 8) | (standardSensorAry[2 * (channel - 1)
	 ...
	 * 
	 * @param pos1
	 *            Target PWM value for channel #1
	 * @param pos2
	 *            Target PWM value for channel #2
	 * @param pos3
	 *            Target PWM value for channel #3
	 * @param pos4
	 *            Target PWM value for channel #4
	 * @param pos5
	 *            Target PWM value for channel #5
	 * @param pos6
	 *            Target PWM value for channel #6
	 * @param timePeriod
	 *            Execution time in milliseconds
	 * 
	...
	/**
	 * Sends the position control command to all 6 servo motor control channels
	 ...
	 * 
	 * @param pos1
	 *            Target position for channel #1 (Left Motor on X80Pro)
	 * @param pos2
	 *            Target position for channel #2 (-Right Motor on X80Pro)
	 * @param pos3
	 *            Target position for channel #3 (NO_CTRL on X80Pro)
	 * @param pos4
	 *            Target position for channel #4 (NO_CTRL on X80Pro)
	 * @param pos5
	 *            Target position for channel #5 (NO_CTRL on X80Pro)
	 * @param pos6
	 *            Target position for channel #6 (NO_CTRL on X80Pro)
	 * @param timePeriod
	 *            Executing time in milliseconds
	 * 
